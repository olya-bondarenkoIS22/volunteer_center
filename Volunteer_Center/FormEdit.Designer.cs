namespace Volunteer_Center
{
    partial class FormEdit
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitle.Text = "РЕДАКТИРОВАНИЕ МЕРОПРИЯТИЯ";
            ...
            lblId.Text = "ID мероприятия:";
            lblId.Font = new Font("Times New Roman", 12, FontStyle.Bold);
            lblId.Size = new Size(200, 30);
            lblId.Location = new Point(10, 70);
            lblId.Visible = false;

            TextBox txtId = new TextBox();
            txtId.Name = "txtId";
            txtId.Size = new Size(320, 30);
            txtId.Location = new Point(220, 70);
            txtId.Font = new Font("Times New Roman", 12, FontStyle.Regular);
            txtId.ReadOnly = true;
            ...
            // Warning label for completed events
            Label lblWarning = new Label();
            lblWarning.Name = "lblWarning";
            lblWarning.Text = "Внимание: Изменение статуса завершенного мероприятия может повлиять на статистику!";
            lblWarning.Font = new Font("Times New Roman", 10, FontStyle.Bold);
            lblWarning.ForeColor = Color.Orange;
            lblWarning.Size = new Size(540, 30);
            lblWarning.Location = new Point(10, 340);
            ...
            buttonPanel.Location = new Point(10, 380);
            ...
            lblNote.Location = new Point(10, 450);
            ...
            lblError.Location = new Point(10, 480);
            ...
            this.Tag = new { txtId, txtName, cmbCategory, dtpDate, txtPlace, numVolunteers, cmbStatus, lblWarning, lblError };
